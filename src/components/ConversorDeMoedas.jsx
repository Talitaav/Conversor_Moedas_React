...
function ConversorDeMoedas() {
    ...
    useEffect(() => {
        fetch('http://api.exchangeratesapi.io/v1/latest?access_key=b82fe39299e1a115089ea350aeb5f6d8&format=1')
    ...
    const converterMoeda = () => {
        fetch(`http://api.exchangeratesapi.io/v1/latest?access_key=b82fe39299e1a115089ea350aeb5f6d8&format=1=${deMoeda}&symbols=${paraMoeda}`)
            .then(response => response.json())
            .then(data => {
